...
int main (void) {
	...
	std::cout << YELLOW << ":::::::::::FORWARD_ITERS::::::::::::\n" << RES ;
	{
		...
		std::set<int>::const_iterator c_start(myset.begin());
	...
	std::cout << YELLOW << ":::::::::::REVERSED_ITERS:::::::::::\n" << RES ;
	{
		...
		std::set<int>::const_reverse_iterator c_rit(myset.rbegin());
	...
	std::cout << YELLOW << "::::::::::::::INSERT::::::::::::::::\n" << RES ;
	{
		...
		std::pair<std::set<int>::iterator, bool> ret = myset.insert(1337);
		...
		std::set<int>::iterator ret_it = myset.insert(myset.begin(), 42);
